...
def display_surface_and_curve(psi, psi_d, a1, a2, b1, b2,
    ...
    Interactive mode uses ipywidgets sliders (requires ipywidgets to be active in the kernel).
    ...
    interactive : bool, if True show ipywidgets sliders for ell, E, u0, v0.
